...
async function getBridgedChannelCount(hubID) {
...
module.exports.run = async (client, message, args, config) => {
  ...
  if (!hubID) return messageFail(client, message, `There is no hub named \`${hubName}\`! Try finding it by looking for one of the first messages in your channel with the discord search sorted by oldest message.`);
